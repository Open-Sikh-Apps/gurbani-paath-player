...
const IMAGE_LIGHT_SRC = join(
  APP_ROOT,
  "downloaded-assets/sevadaar-designer-app-icons/for-r2/sggsj-light-2.jpg",
);
...
const IMAGE_PATH = {
  light: "/images/sggsj-light-2.jpg",
...
async function main(): Promise<void> {
  ...
  copyFileSync(IMAGE_LIGHT_SRC, join(UPLOAD_DIR, "images/sggsj-light-2.jpg"));
